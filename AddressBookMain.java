public class AddressBookMain extends javax.swing.JPanel {
	...
	public static void addEntry(AddressBook addressBook) {
		...
		jTable.setValueAt(addressBook.getPhoneNo(), rowCnt, 6);
	...
	public static void editEntry(AddressBook addressBook) {
		...
		jTable.setValueAt(addressBook.getCity(), getSelectedRow(), 3);
		jTable.setValueAt(addressBook.getState(), getSelectedRow(), 4);
		jTable.setValueAt(addressBook.getZip(), getSelectedRow(), 5);
		jTable.setValueAt(addressBook.getPhoneNo(), getSelectedRow(), 6);
	}
	...
	class AbstractTable extends javax.swing.table.AbstractTableModel {
		private String[] columnNames = { "First Name", "Last Name", "Address", "City", "State", "Zip Code", "Phone Number"  };
